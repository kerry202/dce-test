...
public abstract class Chart<T extends ChartData<? extends IDataSet<? extends Entry>>> extends
     ...
     */
    private String mNoDataText = "No data available.";
...
//            Log.d("length = ", "" + mIndicesToHighlight.length);
//            Log.d("mIndicesToHighlight[0]=", mIndicesToHighlight[0] + "");
//        } else {
//            Log.d("mIndicesToHighlight = ", "null");
//        }
...
//                Log.i(LOG_TAG, "Highlighted: " + high.toString());
            ...
            if (e == null) {
//                Log.i(LOG_TAG, "mIndicesToHighlight = null");
                mIndicesToHighlight = null;
                high = null;
            } else {
                if (this instanceof BarLineChartBase
                        && ((BarLineChartBase) this).isHighlightFullBarEnabled()) {
//                    Log.i(LOG_TAG, "this instanceof BarLineChartBase");
