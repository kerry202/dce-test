...
public class CombinedChartRenderer extends DataRenderer {
    ...
    public void drawHighlighted(Canvas c, Highlight[] indices) {
        ...
        if (chart == null) {
//            Log.d("drawHighlighted", " chart == null ");
            return;
        }
//        Log.d("drawHighlighted", " chart != null ");
        for (DataRenderer renderer : mRenderers) {
...
//                Log.d("drawHighlighted", " = LineChartRenderer ");
                data = ((LineChartRenderer) renderer).mChart.getLineData();
            }
            else if (renderer instanceof CandleStickChartRenderer){
//                Log.d("drawHighlighted", " = CandleStickChartRenderer ");
...
//                if (h.getDataIndex() == dataIndex || h.getDataIndex() == -1)   // CombinedChart highlight不显示时可注释
                    dataIndices.add(h);
            }
//            Log.d("drawHighlighted", "dataIndices.size() == " + dataIndices.size());
