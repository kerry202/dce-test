...
//        Log.d("drawHighlighted", "  == drawHighlighted");
        CandleData candleData = mChart.getCandleData();

        for (Highlight high : indices) {
//            Log.d("drawHighlighted", "high.getDataSetIndex() == " + high.getDataSetIndex());
            final int minDataSetIndex = high.getDataSetIndex() == -1
                    ? 0
                    : high.getDataSetIndex();

//            Log.d("drawHighlighted", "minDataSetIndex == " + minDataSetIndex);
            final int maxDataSetIndex = high.getDataSetIndex() == -1
                    ? candleData.getDataSetCount()
                    : (high.getDataSetIndex() + 1);
//            Log.d("drawHighlighted", "maxDataSetIndex == " + maxDataSetIndex);
            ...
            for (int dataSetIndex = minDataSetIndex;
                ...
                // x-position
//                Log.d("drawHighlighted", "xIndex == " + xIndex);
                ICandleDataSet set = mChart.getCandleData().getDataSetByIndex(dataSetIndex);
//                Log.d("drawHighlighted", "set.isHighlightEnabled() == " + set.isHighlightEnabled());
                if (set == null || !set.isHighlightEnabled())
                    continue;

                CandleEntry e = set.getEntryForXIndex(xIndex);
                if (e != null) {
//                    Log.d("drawHighlighted", "e.getXIndex() == " + e.getXIndex());
                }
...
//
                float closeValue = e.getClose() * mAnimator.getPhaseY();
                float y = closeValue;
...
//                Log.d("drawHighlighted", "set == " + set.isHighlightEnabled());
                // draw the lines
