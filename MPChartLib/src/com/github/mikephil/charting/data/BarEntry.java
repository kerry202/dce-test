...
public class BarEntry extends Entry {
    ...
    public BarEntry(float val, int xIndex, float high, float low, float open, float close,boolean isFromKline) {
        super(val, xIndex);
        this.mHigh = high;
        this.mLow = low;
        this.mOpen = open;
    ...
    public String toString() {
        return "BarEntry{" +
                "mVals=" + Arrays.toString(mVals) +
                ", mNegativeSum=" + mNegativeSum +
                ", mPositiveSum=" + mPositiveSum +
                ", mHigh=" + mHigh +
                ", mLow=" + mLow +
                ", mClose=" + mClose +
                ", mOpen=" + mOpen +
                ", mIsFromKline=" + mIsFromKline +
                '}';
    }
}
