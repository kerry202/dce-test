...
//        Log.d("BarLineChartTouc", "ev == " + event.getAction());
        if (mVelocityTracker == null) {
            mVelocityTracker = VelocityTracker.obtain();
//            Log.d("BarLineChartTouc", "mVelocityTracker == null");
        }
        mVelocityTracker.addMovement(event);

        if (event.getActionMasked() == MotionEvent.ACTION_CANCEL) {
//            Log.d("BarLineChartTouc", "ev == MotionEvent.ACTION_CANCEL");
            if (mVelocityTracker != null) {
        ...
        if (mTouchMode == NONE) {
//            Log.d("BarLineChartTouc", "mTouchMode == NONE");
...
//                Log.d("BarLineChartTouc", " == MotionEvent.ACTION_DOWN");
                startAction(event);
...
//                Log.d("BarLineChartTouc", " == MotionEvent.ACTION_POINTER_DOWN");
...
//                Log.d("BarLineChartTouc", " == MotionEvent.ACTION_MOVE");
                if (mTouchMode == DRAG) {
...
//                Log.d("BarLineChartTouc", " == MotionEvent.ACTION_UP");
...
//                Log.d("BarLineChartTouc", " == MotionEvent.ACTION_POINTER_UP");
...
//                Log.d("BarLineChartTouc", " == MotionEvent.ACTION_CANCEL");
                mTouchMode = NONE;
                endAction(event);
                break;
        }
