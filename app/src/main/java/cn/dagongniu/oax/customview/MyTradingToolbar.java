...
public class MyTradingToolbar extends Toolbar {
    ...
    public MyTradingToolbar(Context context) {
        this(context, null);
    }

    public MyTradingToolbar(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MyTradingToolbar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        mContext = context;
        View v = LayoutInflater.from(context).inflate(R.layout.toolbar_trading_layout, this, false);
        addView(v);
     ...
     * @param c
     */
    public void setTitleNameText(String c) {
        tv_left_name.setText(c);
    }
