 ...
 * EditText 下拉菜单
 */
public class DropEditText extends EditText implements AdapterView.OnItemClickListener, PopupWindow.OnDismissListener, View.OnClickListener {
