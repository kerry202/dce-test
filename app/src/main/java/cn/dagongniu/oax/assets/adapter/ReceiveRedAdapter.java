 ...
 * 发出红包收到红包  适配器
 */
public class ReceiveRedAdapter extends BaseQuickAdapter<GrabRedPacketRecordBean.DataBean.GrabRedPacketPageInfoBean.ListBean, BaseViewHolder> {


    Context context;

    public ReceiveRedAdapter(Context context) {
        super(R.layout.send_receive_redenvelope_item_layout);
        this.context = context;
    }

    @Override
    protected void convert(BaseViewHolder helper, GrabRedPacketRecordBean.DataBean.GrabRedPacketPageInfoBean.ListBean listBean) {
