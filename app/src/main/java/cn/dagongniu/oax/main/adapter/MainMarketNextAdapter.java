 ...
 * 推荐市场- 第二页初始化值 适配器
 */
public class MainMarketNextAdapter extends BaseQuickAdapter<IndexPageBean.DataBean.RecommendMarketListBean, BaseViewHolder> {

    private Context context;
    List<IndexPageBean.DataBean.RecommendMarketListBean> lineData;//第一次

    public MainMarketNextAdapter(Context context, List<IndexPageBean.DataBean.RecommendMarketListBean> lineData) {
        super(R.layout.adapter_mainmarket);
        this.context = context;
        this.lineData = lineData;
    }

    List<IndexPageBean.DataBean.RecommendMarketListBean> lineDataRefresh;//刷新的值
    ...
    @NonNull
    @Override
    public List<IndexPageBean.DataBean.RecommendMarketListBean> getData() {
        return super.getData();

    }

    @Override
    protected void convert(BaseViewHolder helper, IndexPageBean.DataBean.RecommendMarketListBean data) {
