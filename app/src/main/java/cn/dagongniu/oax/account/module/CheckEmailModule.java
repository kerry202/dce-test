 ...
 * 判断邮箱是否已被注册 module
 */
public class CheckEmailModule extends BaseModule<String, HttpBaseBean> {

    public CheckEmailModule(Activity activity) {
        super(activity);
    }
    ...
    public void requestServerDataOne(final OnBaseDataListener<HttpBaseBean> onBaseDataListener, RequestState state, String... parm) {
        ...
        HttpUtils.getInstance().postLang(Http.USER_CHECKEMAIL, hashMap, activity, new OnBaseDataListener<String>() {
            @Override
