...
//                                DownloadAppUtils.downloadForAutoInstall(activity, apkPath, "demo.apk", serverVersionName);
                                DownloadAppUtils.download(activity, apkPath, serverVersionName, true);
                            } else {
                                ...
                                }).setContent(activity.getResources().getString(R.string.no_wifi)).show();
                            }
        ...
        String content = activity.getResources().getString(R.string.find_updating) + serverVersionName  + activity.getResources().getString(R.string.whether_updating);
        if (!TextUtils.isEmpty(updateInfo)) {
            content = activity.getResources().getString(R.string.find_updating) + serverVersionName + activity.getResources().getString(R.string.whether_updating)+ updateInfo;
        }
